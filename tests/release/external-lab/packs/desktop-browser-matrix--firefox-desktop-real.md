...
**Criterion:** `firefox-desktop-real`

**Evidence kind:** `manual-browser`

**Closing evidence template:** `tests/release/evidence-templates/desktop-browser-matrix--firefox-desktop-real.json`

## Objective

Validate Reeris Core in current stable Mozilla Firefox — desktop using the canonical release fixtures.
...
1. Complete the evidence template at `tests/release/evidence-templates/desktop-browser-matrix--firefox-desktop-real.json`.
