# TalkBack + Chrome acceptance

**Release:** Reeris UI 0.52.0

**Gate:** `assistive-technology`

**Criterion:** `talkback-chrome`

**Evidence kind:** `assistive-technology`

**Closing evidence template:** `tests/release/evidence-templates/assistive-technology--talkback-chrome.json`

## Objective

Validate representative Reeris semantics with TalkBack and Chrome on Android.

## Before you start

- Real Android device or trusted real-device cloud
- Current TalkBack and Chrome
- Record gesture/navigation mode used
...
1. Complete the evidence template at `tests/release/evidence-templates/assistive-technology--talkback-chrome.json`.
