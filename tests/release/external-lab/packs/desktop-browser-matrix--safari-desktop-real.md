...
**Criterion:** `safari-desktop-real`

**Evidence kind:** `manual-browser`

**Closing evidence template:** `tests/release/evidence-templates/desktop-browser-matrix--safari-desktop-real.json`

## Objective

Validate Reeris Core in current stable Safari — macOS desktop using the canonical release fixtures.
...
1. Complete the evidence template at `tests/release/evidence-templates/desktop-browser-matrix--safari-desktop-real.json`.
