# NVDA desktop screen-reader acceptance

**Release:** Reeris UI 0.52.0

**Gate:** `assistive-technology`

**Criterion:** `nvda-desktop`

**Evidence kind:** `assistive-technology`

**Closing evidence template:** `tests/release/evidence-templates/assistive-technology--nvda-desktop.json`

## Objective

Validate representative Reeris semantics with NVDA on Windows.

## Before you start

- Current supported NVDA version
- Supported Chrome, Edge or Firefox version
- Speech enabled; default browse/focus modes unless a deviation is documented
...
1. Complete the evidence template at `tests/release/evidence-templates/assistive-technology--nvda-desktop.json`.
