...
**Criterion:** `safari-ipados-real`

**Evidence kind:** `manual-browser`

**Closing evidence template:** `tests/release/evidence-templates/mobile-browser-matrix--safari-ipados-real.json`

## Objective

Validate Reeris on Safari — real iPad, including touch, safe areas and native form controls.
...
1. Complete the evidence template at `tests/release/evidence-templates/mobile-browser-matrix--safari-ipados-real.json`.
